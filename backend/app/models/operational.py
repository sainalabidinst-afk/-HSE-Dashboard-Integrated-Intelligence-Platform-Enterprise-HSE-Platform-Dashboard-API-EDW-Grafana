...
class EquipmentInspection(Base):
    ...
    equipment_id = Column(String(50), ForeignKey("hse.dim_equipment(equipment_id)"), nullable=False)
...
class HIRAAssessment(Base):
    ...
    hazard_id = Column(String(20), ForeignKey("hse.dim_hazard(hazard_id)"))
...
class ContractorRecord(Base):
    ...
    record_id = Column(String(50), primary_key=True)
    contractor_id = Column(String(20), ForeignKey("hse.dim_contractor(contractor_id)"), nullable=False)
...
class EnvironmentalReading(Base):
    ...
    env_id = Column(String(30), ForeignKey("hse.dim_environmental(env_id)"))
